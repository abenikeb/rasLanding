		...
		<section className="page-intro section-padding pb-0">
			<div className="container">
				<div className="row md-marg">
					...
					<div className="col-lg-6 valign secondary-color mt-40">
						<div className="cont">
							<h5 className="about-us-content text-bright mb-30">
								ራስሲነርጂ <span className="fw-200">ID ካርድ ሶልዊሽን እና ህትመት ድርጅት</span>{" "}
								የተለያዩ የህትመት ስራዎችን የተማሪዎች ዲጂታል መታወቂያ ካርድ ፣ የመንግስት መስሪያ ቤት መታወቂያ
								እንዲሁም የድርጅቶችን አርማ ጨምሮ የተለያዩ የትምርት መገልገያ መሳሪያዎችን በተመጣጣኝ ዋጋ የሚያቀርብ
								ድርጅት ነው::
							</h5>
							<h5 className="about-us-content text-bright mb-30">
								አሁን ደግሞ{" "}
