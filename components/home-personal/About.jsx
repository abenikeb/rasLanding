						...
						<div className="cont">
							...
							<div className="text secondary-color">
								<h4 className="about-us-content text-bright mb-30">
									...
									የተለያዩ የህትመትና የተማሪዎች ዲጂታል መታወቂያ ካርድ እንዲሁም{" "}
									<span className="fw-200">
										ለተማሪ ልጅዎት አስፈላጊ የሆኑ ወሳኝ የትምህርት መገልገያ መሳሪያዎችን
									</span>{" "}
									በአነስተኛ ዋጋ የሚያቀርብ ድርጅት ነው::
								</h4>
								<p className="div-p">
									በተጨማሪም ከተለያዩ ትምህርት ቤቶች ጋር በአጋርነት በመሆን የተማሪዎችን ስም እና የትምህርት ቤት
									አርማዎች የታተመባቸው ቦርሳዎች፣ የምሳ እቃዎች እና ዩኒፎርሞችን ከገብያ ሂሳብ በታላቅ ቅናሽ
									ለወላጆች አቅርበናል በዚህ እድል ይጠቀሙ እንላለን::
								</p>
								<br />
