					...
					<div className="col-lg-8 -mt-40">
						<div
							...
							<p className="address-details mb-20">
								...
								መታወቂያ ቁጥር ከታች በሚገኘው{" "}
								<span className="main-color">እዚህ ይመዝገቡ</span> ቅጽ ላይ በመሙላት
								የሚያገኙትን የመክፈያ ቁጥር{" "}
								<span className="main-color">Reference number</span> በመያዝ ከታች
								በምስሉ ላይ በምትመለከቱት ወደ ቴሌብር በመሄድ ያስገባሉ : ከከፈሉም በኋላ እኛ በሁለት ቀናት ውስጥ
								ያሉበት ድረስ እናደርሳለን ወይም በትምርት ቤቶ አማካኝነት እንልካለን::
							</p>
