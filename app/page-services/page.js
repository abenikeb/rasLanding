								...
								<div className="row">
									...
									<div className="col-lg-8">
										<div className="text secondary-color">
											<h4>
												ራስ ሲነርጂ ካርድ ሶልዊሽን እና ህትመት ድርጅት የተለያዩ የህትመት እና የተማሪዎች
												ዲጂታል መታወቂያ ካርድ : የመንግስት መስሪያ ቤት መታወቂያ ካርድን ጨምሮ በተለያዩ
												የትምርት መገልገያ መሳሪያዎችን በአነስተኛ ዋጋ የሚያቀርብ ድርጅት ነው:: አሁን ደግሞ
												የባር ኮድ የተገጠመለት የዲጂታል ተማሪዎች መታወቂያ ካርድ በመስራት የተማሪዎችን መረጃ
												የሚይዝ ለወላጆች በቀላሉ የልጆቻቸውን የት/ቤት መግቢያና እና መውጫ ባሉበት ቦታ ሆነው
												በስልካቸው መቆጣጠር የሚችሉበት ሲስተም ሰርቷል:: ይህም ለቤተሰቦች የአእምሮ ሰላም
